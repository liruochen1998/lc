...
public class Solution {
  // way to improve: use double pointer so the space is O1
    public ListNode getIntersectionNode(ListNode headA, ListNode headB) {
      // declare a hashset to hold nodes in list A
      ...
      // iterate through listB and check whether any node in B is in the hashset
      while (headB != null) {
